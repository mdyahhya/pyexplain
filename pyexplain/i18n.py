...
def decode_traceback(traceback_text: str, add_branding: bool = True) -> Dict[str, Any]:
    ...
    Args:
        ...
        add_branding: Whether to add "Powered by PyExplain" footer
        
    Returns:
        Dictionary with error_type, simple_explanation, fix_suggestion, etc.
    ...
    if not traceback_text or not isinstance(traceback_text, str):
        return {
            ...
            "simple_explanation": "PyExplain needs a valid error traceback to decode. Please provide error text.",
...
def decode_exception(exception: Exception, add_branding: bool = True) -> Dict[str, Any]:
    ...
    Args:
        ...
        add_branding: Whether to add branding footer
    ...
    if not isinstance(exception, BaseException):
        return {
            ...
            "simple_explanation": "PyExplain needs a valid Exception object. Please pass an exception from except blocks.",
...
def safe_run(code: str, filename: str = "<string>", globals_dict: Optional[dict] = None,
    ...
    Args:
        ...
        filename: Filename for traceback display
        globals_dict: Global namespace for execution
        locals_dict: Local namespace for execution
        add_branding: Whether to add branding footer
        
    Returns:
        Success dict or error dict with decoded information
    ...
    if not code or not isinstance(code, str):
        return {
            ...
            "simple_explanation": "PyExplain needs valid Python code to run. Please provide a code string.",
...
def format_decoded_output(decoded: Dict[str, Any], include_technical: bool = False,
    ...
    Args:
        decoded: Dictionary from decode_traceback() or decode_exception()
        include_technical: Show technical details
